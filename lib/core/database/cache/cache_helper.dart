...
//
//   // تخزين الإشعار في SharedPreferences
...
//     notifications.add(jsonEncode(message.toMap())); // تحويل الرسالة إلى JSON لتخزينها
//     await prefs.setStringList(_notificationsKey, notifications);
//   }
//
//   // استرجاع الإشعارات المخزنة
//   static Future<List<RemoteMessage>> getStoredNotifications() async {
//     final prefs = await SharedPreferences.getInstance();
//     List<String> notifications = prefs.getStringList(_notificationsKey) ?? [];
//     return notifications
//         .map((e) => RemoteMessage.fromMap(jsonDecode(e))) // تحويل JSON إلى RemoteMessage
//         .toList();
//   }
// }